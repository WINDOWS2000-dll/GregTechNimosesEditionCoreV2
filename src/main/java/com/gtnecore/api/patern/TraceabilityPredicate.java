...
public class TraceabilityPredicate {
    ...
    private static final Supplier<gregtech.api.pattern.TraceabilityPredicate> ELEVATOR_MOTOR_PREDICATE =
            () ->
                    new gregtech.api.pattern.TraceabilityPredicate(blockWorldState -> {
