...
import static com.gtnecore.api.patern.TraceabilityPredicate.elevatorMotors;
...
public class MetaTileEntitySpaceElevator extends MultiblockWithDisplayBase implements ISpaceElevatorProvider {
        ...
        if (!this.isExtended) {
            return FactoryBlockPattern.start(RIGHT, DOWN, FRONT)
                    ...
                    .aisle("               F D F               ", "                 D                 ",
                            ...
                            "        D       DCD       D        ", "       DD      DDCDD      DD       ",
                            "       D       D C D       D       ", "       D       D C D       D       ",
                            "      DD       D C D       DD      ", "      D        D C D        D      ",
                            "     DD VV     XDCDX     VV DD     ", "    DD  VI     XDCDX     IV  DD    ",
                            " DDDD   VV     XDCDX     VV   DDDD ", "FFFD    VVFFFFFDDDDDFFFFFVV    DFFF",
                            "AAAAAAAAVV  AAAXXXXXAAA  VVAAAAAAAA")
                    .aisle("              F     F              ", "                                   ",
                            "                                   ", "                                   ",
                            "                                   ", "                                   ",
                            "             F       F             ", "            E         E            ",
                            ...
                            "       E                   E       ", "      EE                   EE      ",
                            "      EE                   EE      ", "     EE                     EE     ",
                            "    EEE       XD   DX       EEE    ", "   EEE        XD   DX        EEE   ",
                            "  EE          XD   DX          EE  ", "FFF         FFFDDDDDFFF         FFF",
                    ...
                    .aisle("              FD   DF              ", "              ED   DE              ",
                            ...
                            "               C - C               ", "               C - C               ",
                            "               C - C               ", "               C - C               ",
                            "        VV    XC - CX    VV        ", "        VI    XC - CX    IV        ",
                            "        VV    XC - CX    VV        ", "        VVFFFFFDDDDDFFFFFVV        ",
                            "AAAAAAAAVV  AAAXXXXXAAA  VVAAAAAAAA")
                    .aisle("              F     F              ", "                                   ",
                            "                                   ", "                                   ",
                            "                                   ", "                                   ",
                    ...
                    .where('~', selfPredicate())
                    .where('D',
                            states(GTNEMetaBlocks.ELEVATOR_CASING
                                    .getState(ElevatorCasing.CasingType.ELEVATOR_BASE_CASING)))
                    .where('F',
                            states(GTNEMetaBlocks.ELEVATOR_CASING
                                    .getState(ElevatorCasing.CasingType.ELEVATOR_INTERNAL_STRUCTURE)))
                    .where('E',
                            states(GTNEMetaBlocks.ELEVATOR_CASING
                                    .getState(ElevatorCasing.CasingType.ELEVATOR_SUPPORT_STRUCTURE)))
                    .where('A',
                            states(GTNEMetaBlocks.ELEVATOR_CASING
                                    .getState(ElevatorCasing.CasingType.HIGH_STRENGTH_CONCRETE)))
                    .where('B',
                            states(GTNEMetaBlocks.ELEVATOR_CASING.getState(ElevatorCasing.CasingType.ELEVATOR_CABLE)))
                    ...
                    .where('V',
                            states(GTNEMetaBlocks.ELEVATOR_CASING
                                    .getState(ElevatorCasing.CasingType.ELEVATOR_BASE_CASING)).or(
                                            abilities(MultiblockAbility.IMPORT_ITEMS, MultiblockAbility.IMPORT_FLUIDS,
                                                    MultiblockAbility.EXPORT_FLUIDS, MultiblockAbility.EXPORT_ITEMS,
                                                    MultiblockAbility.COMPUTATION_DATA_RECEPTION).setPreviewCount(0)))
                    .build();
        } else {
            return FactoryBlockPattern.start(RIGHT, DOWN, FRONT)
                    .aisle("                                               ",
                    ...
                    .aisle("                                               ",
                            ...
                            "                                               ",
                            "                                               ",
                            "   AA     AAAAAAAAAAAAAAAAAAAAAAAAAAA     AA   ")
                    .aisle("                                               ",
                            "                                               ",
                            "                                               ",
                            "                                               ",
                            ...
                            "                     V V V                     ",
                            "                     V V V                     ",
                            "  AA     AAAAAAAAAAAAV V VAAAAAAAAAAAA     AA  ")
                    .aisle("                                               ",
                            "                                               ",
                            "                                               ",
                            "                                               ",
                    ...
                    .aisle("                                               ",
                            ...
                            "         D                           D         ",
                            "        FFF          F F F          FFF        ",
                            "  AA  AAAAAAAAAAAAAAA     AAAAAAAAAAAAAAA  AA  ")
                    .aisle("                                               ",
                            "                                               ",
                            "                                               ",
                            "                                               ",
                    ...
                    .aisle("                     F D F                     ",
                            ...
                            "            DD       D C D       DD            ",
                            "            D        D C D        D            ",
                            " VV        DD VV     XDCDX     VV DD        VV ",
                            " VI       DD  VI     XDCDX     IV  DD       IV ",
                            " VV    DDDD   VV     XDCDX     VV   DDDD    VV ",
                            "FVVFFFFFFD    VVFFFFFDDDDDFFFFFVV    DFFFFFFVVF",
                            "AVVAAAAAAAAAAAVV  AAAXXXXXAAA  VVAAAAAAAAAAAVVA")
                    .aisle("                    F     F                    ",
                            "                                               ",
                            "                                               ",
                            "                                               ",
                            ...
                            "         EEE        XD   DX        EEE         ",
                            "        EE          XD   DX          EE        ",
                            "F     FFF         FFFDDDDDFFF         FFF     F",
                            "A     AAAAAAAA    AAAXXXXXAAA    AAAAAAAA     A")
                    .aisle("                    FD   DF                    ",
                            "                    ED   DE                    ",
                            "                    ED   DE                    ",
                            "                    ED   DE                    ",
                            ...
                            " VI           VI    XC - CX    IV           IV ",
                            " VV           VV    XC - CX    VV           VV ",
                            "FVVFFFF       VVFFFFFDDDDDFFFFFVV       FFFFVVF",
                            "AVV   AAAAAAAAVV  AAAXXXXXAAA  VVAAAAAAAA   VVA")
                    .aisle("                    F     F                    ",
                            "                                               ",
                            "                                               ",
                            "                                               ",
    ...
    protected ModularUI.Builder createUITemplate(EntityPlayer entityPlayer) {
        ...
        // Extend Button
        builder.widget(new ImageCycleButtonWidget(173, 213, 18, 18, GTNECoreTextures.BUTTON_ELEVATOR_EXTENSION,
                this::isExtended, this::setExtended)
                        .setTooltipHoverString("gtne.gui.multiblock.space_elevator_extended"));
        ...
        builder.widget(new ClickButtonWidget(173, 173, 18, 18, "", data -> enableAllModules())
                .setButtonTexture(GTNECoreTextures.BUTTON_ENABLE_STATIC)
        ...
        builder.widget(new ClickButtonWidget(173, 191, 18, 18, "", data -> disableAllModules())
                .setButtonTexture(GTNECoreTextures.BUTTON_DISABLE_STATIC)
        ...
        if (Mods.GalacticraftCore.isModLoaded()) {
            ...
            }).setButtonTexture(GTNECoreTextures.BUTTON_ELEVATOR_TELEPORT)
                    .setTooltipText("gtne.gui.multiblock.space_elevator_teleport"));
        }
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        if (this.isStructureFormed()) {
            textList.add(TextComponentUtil.translationWithColor(TextFormatting.BLUE,
                    "gtne.machine.space_elevator.motor_tier", this.motorTier));
            textList.add(TextComponentUtil.translationWithColor(TextFormatting.YELLOW,
                    "gtne.machine.space_elevator.max_module", getMaxModules()));
            ...
            if (this.spaceElevatorReceivers.isEmpty()) {
                ...
                textList.add(TextComponentUtil.translationWithColor(
                        getModuleCount() < getMaxModules() ? TextFormatting.AQUA : TextFormatting.YELLOW,
                        "gtne.machine.space_elevator.total_modules", getModuleCount()));
                textList.add(TextComponentUtil.translationWithColor(TextFormatting.GREEN,
                        "gtne.machine.space_elevator.modules"));
                ...
                uniqueNames.forEach(s -> textList.add(TextComponentUtil.translationWithColor(TextFormatting.WHITE, s,
                        Collections.frequency(moduleNames, s))));
            }
        }
    }
