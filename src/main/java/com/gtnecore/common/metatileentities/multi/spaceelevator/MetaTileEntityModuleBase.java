...
public abstract class MetaTileEntityModuleBase extends MultiblockWithDisplayBase
                                               implements ISpaceElevatorReceiver, IWorkable {
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        return GTNECoreTextures.ELEVATOR_CASING;
    }
